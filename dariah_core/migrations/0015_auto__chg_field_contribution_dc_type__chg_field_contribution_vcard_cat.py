...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contribution.dc_type'
        db.alter_column(u'dariah_contributions_contribution', 'dc_type', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Contribution.vcard_category'
        db.alter_column(u'dariah_contributions_contribution', 'vcard_category', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Contribution.dc_type'
        db.alter_column(u'dariah_contributions_contribution', 'dc_type', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Contribution.vcard_category'
        db.alter_column(u'dariah_contributions_contribution', 'vcard_category', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
    ...
    models = {
        ...
        u'dariah_contributions.contribution': {
            ...
            'dc_type': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'vcard_category': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
