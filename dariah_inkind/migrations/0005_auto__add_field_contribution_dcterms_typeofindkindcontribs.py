...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.dcterms_typeofindkindcontribs'
        db.add_column(u'dariah_inkind_contribution', 'dcterms_typeofindkindcontribs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.dcterms_typeofindkindcontribs'
        db.delete_column(u'dariah_inkind_contribution', 'dcterms_typeofindkindcontribs')
