...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.dc_type'
        db.add_column(u'dariah_contributions_contribution', 'dc_type',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contribution.vcard_category'
        db.add_column(u'dariah_contributions_contribution', 'vcard_category',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contribution.dcterms_spatial'
        db.add_column(u'dariah_contributions_contribution', 'dcterms_spatial',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.dc_type'
        db.delete_column(u'dariah_contributions_contribution', 'dc_type')

        # Deleting field 'Contribution.vcard_category'
        db.delete_column(u'dariah_contributions_contribution', 'vcard_category')

        # Deleting field 'Contribution.dcterms_spatial'
        db.delete_column(u'dariah_contributions_contribution', 'dcterms_spatial')
    ...
    models = {
        ...
        u'dariah_contributions.contribution': {
            ...
            'dc_type': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'vcard_category': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
