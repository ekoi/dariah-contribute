...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.dcterms_reason'
        db.add_column(u'dariah_inkind_contribution', 'dcterms_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.dcterms_reason'
        db.delete_column(u'dariah_inkind_contribution', 'dcterms_reason')
