...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DcContributor.foaf_email'
        db.add_column(u'dariah_inkind_dccontributor', 'foaf_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DcCreator.foaf_email'
        db.add_column(u'dariah_inkind_dccreator', 'foaf_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DcContributor.foaf_email'
        db.delete_column(u'dariah_inkind_dccontributor', 'foaf_email')

        # Deleting field 'DcCreator.foaf_email'
        db.delete_column(u'dariah_inkind_dccreator', 'foaf_email')
    ...
    models = {
        ...
        u'dariah_inkind.dccontributor': {
            ...
            'foaf_email': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'blank': 'True'}),
