...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dariah_annual_value_annualvalue', (
            ...
            ('justification', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
    ...
    models = {
        ...
        u'dariah_annual_value.annualvalue': {
            ...
            'justification': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
