...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dariah_inkind_dccontributor', (
            (u'person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dariah_person.Person'], unique=True, primary_key=True)),
        ))
        ...
        db.create_table(m2m_table_name, (
            ...
            ('person', models.ForeignKey(orm[u'dariah_person.person'], null=False))
        ))
    ...
    models = {
        ...
        u'dariah_inkind.dccontributor': {
            'Meta': {'object_name': 'DcContributor', '_ormbases': [u'dariah_person.Person']},
            u'person_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dariah_person.Person']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'dariah_inkind.dccreator': {
            'Meta': {'object_name': 'DcCreator', '_ormbases': [u'dariah_person.Person']},
            u'person_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dariah_person.Person']", 'unique': 'True', 'primary_key': 'True'})
        },
