...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.dc_publisher_description_en'
        db.add_column(u'dariah_inkind_contribution', 'dc_publisher_description_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Contribution.dc_publisher_description'
        db.add_column(u'dariah_inkind_contribution', 'dc_publisher_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Contribution.dc_publisher_lang'
        db.add_column(u'dariah_inkind_contribution', 'dc_publisher_lang',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Contribution.dc_publisher_relation'
        db.add_column(u'dariah_inkind_contribution', 'dc_publisher_relation',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.dc_publisher_description_en'
        db.delete_column(u'dariah_inkind_contribution', 'dc_publisher_description_en')

        # Deleting field 'Contribution.dc_publisher_description'
        db.delete_column(u'dariah_inkind_contribution', 'dc_publisher_description')

        # Deleting field 'Contribution.dc_publisher_lang'
        db.delete_column(u'dariah_inkind_contribution', 'dc_publisher_lang')

        # Deleting field 'Contribution.dc_publisher_relation'
        db.delete_column(u'dariah_inkind_contribution', 'dc_publisher_relation')
    ...
    models = {
        ...
        u'dariah_inkind.contribution': {
            ...
            'dcterms_contribanddariah': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
