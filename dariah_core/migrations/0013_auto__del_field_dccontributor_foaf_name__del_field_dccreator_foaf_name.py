...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DcContributor.foaf_name'
        db.delete_column(u'dariah_contributions_dccontributor', 'foaf_name')

        # Deleting field 'DcCreator.foaf_name'
        db.delete_column(u'dariah_contributions_dccreator', 'foaf_name')


    def backwards(self, orm):
        # Adding field 'DcContributor.foaf_name'
        db.add_column(u'dariah_contributions_dccontributor', 'foaf_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'DcCreator.foaf_name'
        db.add_column(u'dariah_contributions_dccreator', 'foaf_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
