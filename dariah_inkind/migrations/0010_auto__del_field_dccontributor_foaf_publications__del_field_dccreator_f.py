...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DcContributor.foaf_publications'
        db.delete_column(u'dariah_inkind_dccontributor', 'foaf_publications')

        # Deleting field 'DcCreator.foaf_publications'
        db.delete_column(u'dariah_inkind_dccreator', 'foaf_publications')


    def backwards(self, orm):
        # Adding field 'DcContributor.foaf_publications'
        db.add_column(u'dariah_inkind_dccontributor', 'foaf_publications',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'DcCreator.foaf_publications'
        db.add_column(u'dariah_inkind_dccreator', 'foaf_publications',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
