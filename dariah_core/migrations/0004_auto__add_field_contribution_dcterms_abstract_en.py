...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.dcterms_abstract_en'
        db.add_column(u'dariah_contributions_contribution', 'dcterms_abstract_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.dcterms_abstract_en'
        db.delete_column(u'dariah_contributions_contribution', 'dcterms_abstract_en')
