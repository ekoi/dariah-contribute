...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dariah_contributions_contribution', 'dc_date', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'Contribution.dc_date'
        db.alter_column(u'dariah_contributions_contribution', 'dc_date', self.gf('django.db.models.fields.DateTimeField')())
