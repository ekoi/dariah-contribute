...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.deleted'
        db.add_column(u'dariah_contributions_contribution', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.deleted'
        db.delete_column(u'dariah_contributions_contribution', 'is_deleted')
