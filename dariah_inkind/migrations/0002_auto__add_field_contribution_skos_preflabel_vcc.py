...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.skos_preflabel_vcc'
        db.add_column(u'dariah_inkind_contribution', 'skos_preflabel_vcc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dariah_static_data.TADIRAHVCC'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Contribution.skos_preflabel_vcc'
        db.delete_column(u'dariah_inkind_contribution', 'skos_preflabel_vcc_id')
