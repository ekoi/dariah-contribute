...
yourlabs.Widget.prototype.selectChoice = function(choice) {
    ...
    var b = choice[(choice.length-1)].parentElement;
    
    if (b==undefined) {
    	var newChoiceTxt = htmlDecode(choice[(choice.length-1)].innerHTML);
    	choice[(choice.length-1)].innerHTML = newChoiceTxt;
    }
    else {
...
yourlabs.Widget.prototype.deselectChoice = function(choice) {
    var value = this.getValue(choice);
    alert("yourlabs.Widget.prototype.deselectChoice ");
