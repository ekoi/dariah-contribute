...
class DcCreatorDetailMixin(BaseDetailView):
    model = DcCreator

    def get_context_data(self, **kwargs):
        context = super(DcCreatorDetailMixin, self).get_context_data(**kwargs)
        c = context['object']
    ...
    def get_fields(self, c, meta_metadata=False):
        ...
        of a DcCreator instance to be rendered in the template.
        """
...
class DcCreatorDetail(DcCreatorDetailMixin, SingleObjectTemplateResponseMixin):
    pass
