...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'dariah_contributions_contribution_skos_preflabel_technique')
        ...
        db.alter_column(u'dariah_contributions_contribution', 'dc_coverage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dariah_static_data.Country'], null=True))

    def backwards(self, orm):
        # Removing M2M table for field skos_preflabel_technique on 'Contribution'
        db.delete_table(db.shorten_name(u'dariah_contributions_contribution_skos_preflabel_technique'))


        # Changing field 'Contribution.dc_coverage'
        db.alter_column(u'dariah_contributions_contribution', 'dc_coverage_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dariah_static_data.Country']))
    ...
    models = {
        ...
        u'dariah_contributions.contribution': {
            ...
            'dcterms_abstract_en': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
