...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.vcard_logo'
        db.add_column(u'dariah_contributions_contribution', 'vcard_logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contribution.vcard_organization'
        db.add_column(u'dariah_contributions_contribution', 'vcard_organization',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.vcard_logo'
        db.delete_column(u'dariah_contributions_contribution', 'vcard_logo')

        # Deleting field 'Contribution.vcard_organization'
        db.delete_column(u'dariah_contributions_contribution', 'vcard_organization')
