...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'dariah_contributions_contribution_skos_preflabel_discipline')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'dariah_contributions_contribution_skos_preflabel_discipline'))
