...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DcContributor.foaf_email'
        db.alter_column(u'dariah_inkind_dccontributor', 'foaf_email', self.gf('django.db.models.fields.EmailField')(max_length=75))
        # Deleting field 'Contribution.dcterms_spatial'
        db.delete_column(u'dariah_inkind_contribution', 'dcterms_spatial')

        # Deleting field 'Contribution.vcard_organization'
        db.delete_column(u'dariah_inkind_contribution', 'vcard_organization')


        # Changing field 'Contribution.dc_date'
        db.alter_column(u'dariah_inkind_contribution', 'dc_date', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=4, null=True))

        # Changing field 'DcCreator.foaf_email'
        db.alter_column(u'dariah_inkind_dccreator', 'foaf_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'DcContributor.foaf_email'
        db.alter_column(u'dariah_inkind_dccontributor', 'foaf_email', self.gf('django.db.models.fields.EmailField')(max_length=100))
        # Adding field 'Contribution.dcterms_spatial'
        db.add_column(u'dariah_inkind_contribution', 'dcterms_spatial',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Contribution.vcard_organization'
        db.add_column(u'dariah_inkind_contribution', 'vcard_organization',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


        # Changing field 'Contribution.dc_date'
        db.alter_column(u'dariah_inkind_contribution', 'dc_date', self.gf('django.db.models.fields.PositiveIntegerField')(default=datetime.datetime(2015, 2, 10, 0, 0), max_length=4))

        # Changing field 'DcCreator.foaf_email'
        db.alter_column(u'dariah_inkind_dccreator', 'foaf_email', self.gf('django.db.models.fields.EmailField')(max_length=100))
    ...
    models = {
        ...
        u'dariah_inkind.contribution': {
            ...
            'dc_date': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
        ...
        u'dariah_inkind.dccontributor': {
            ...
            'foaf_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
